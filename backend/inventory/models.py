...
class Item(models.Model):
    ...
    # Dead stock fields
    last_stock_movement = models.DateField(null=True, blank=True)
    ...
    def is_dead_stock(self):
        if self.last_stock_movement:
            return (timezone.now().date() - self.last_stock_movement).days > self.dead_stock_threshold_days
        return False
